...
html_file = r"c:\Users\alexc\OneDrive\文件\WikiLLM\outputs\bzs-website-seo-geo-analysis.html"
pdf_file = r"c:\Users\alexc\OneDrive\文件\WikiLLM\outputs\bzs-website-seo-geo-analysis.pdf"
...
try:
    ...
    print(f"[ERROR] PDF conversion timed out (30s exceeded). Edge headless may be hung.")
