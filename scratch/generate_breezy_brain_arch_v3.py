...
# v3 16:9 橫向 HTML/CSS 架構圖內容定義 (依作業流程排序，加入 workflow 且修正箭頭)
html_template = """<!DOCTYPE html>
<html lang="zh-TW">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>BreezyBrain 產品核心架構圖 (v3 16:9 Landscape Architecture)</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        * {
        ...
        .module-card {
            ...
            border-radius: 8px;
            padding: 8px 10px; /* 縮小內邊距以高度適配 16:9 */
            display: flex;
            flex-direction: column;
            gap: 4px;
            flex-grow: 1;
...
<header>
    <div class="logo-title">BreezyBrain 16:9 Landscape Blueprint - v3</div>
...
<div class="architecture-container">
    ...
    <!-- 2. 核心業務層 (依作業流程排序，加入 workflow 且修正箭頭) -->
    <div class="column-wrapper layer-application">
        ...
        <div class="module-card">
            <div class="module-header">工作流與審批引擎 (BPM)</div>
        ...
        <div class="module-card">
            <div class="module-header">電子簽章與 CLM 派單</div>
...
<footer>
    <p>架構圖編號: BZS-ARCH-169-20260528-03 | 蒙恬科技 (PenPower) BreezyBrain 專案開發小組 ． 2026H2 橫向工作流架構藍圖 (技術討論稿)</p>
</footer>
...
def main():
    ...
    # 定義檔案名稱
    output_html_name = f"{now_str}-breezy-brain-architecture_v3.html"
    output_pdf_name = f"{now_str}-breezy-brain-architecture_v3.pdf"
    ...
    # 1. 寫入 HTML 檔案
    print("Writing 16:9 landscape architecture v3 HTML file...")
    ...
    try:
        ...
        # 寫入結果供主腳本參照
        with open("outputs/arch_v3_generation_result.txt", "w", encoding="utf-8") as f:
