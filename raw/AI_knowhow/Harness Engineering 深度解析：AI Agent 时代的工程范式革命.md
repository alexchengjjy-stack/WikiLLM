...
2026 年 2 月，" [Harness Engineering](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Harness+Engineering&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJIYXJuZXNzIEVuZ2luZWVyaW5nIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjcxMTQ3MjUwLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.2VI7vId_xRswwmV_sDzfnW80ZEbRF75xaVrI1MwIY1g&zhida_source=entity) "这个词突然在 AI 工程圈子里火了起来。 [Mitchell Hashimoto](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Mitchell+Hashimoto&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJNaXRjaGVsbCBIYXNoaW1vdG8iLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.qcNOdKB6d4ywyxVyx07bqyCNR33GlIqDQ9SezcwDjO4&zhida_source=entity) 在博客里提了这个说法， [OpenAI](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=OpenAI&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJPcGVuQUkiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.JSDD1v25Zp10I_1Bzd1yTYp2LdSeWpDste_TNyBXM70&zhida_source=entity) 紧接着发了百万行代码的实验报告，Martin Fowler 也跟进写了深度分析——几周之内，这个术语就成了讨论 AI Agent 开发绕不开的话题。本文把 Harness Engineering 的来龙去脉、核心方法和实战经验做了一次系统整理，重点拆解 OpenAI、 [Anthropic](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Anthropic&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJBbnRocm9waWMiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.HihgjJ8lle23oJgASVJcMXj5AWwk-EuKl3UAzUQqDbE&zhida_source=entity) 、Stripe 等团队踩过的坑和沉淀下来的做法。最后，我们对 8 个独立信息源进行交叉对比，梳理出业界已形成共识的六大方面、仍存分歧的四个议题，以及三个最值得探索的空白区。
...
Harness Engineering 并不是凭空出现的，它是 [Prompt Engineering](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Prompt+Engineering&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJQcm9tcHQgRW5naW5lZXJpbmciLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.nhOsx1jPBwy-kYU_EERKRZVeTDcT-DsPsxCTF-m0Whw&zhida_source=entity) 和 [Context Engineering](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Context+Engineering&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJDb250ZXh0IEVuZ2luZWVyaW5nIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjcxMTQ3MjUwLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.w0d9ggNqD2SIsudc2NrY3n9bbuvYKlyWfIKOV1oSY3s&zhida_source=entity) 的自然延伸。三者构成嵌套关系：
...
**Mitchell Hashimoto** （HashiCorp 联合创始人、 [Terraform](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Terraform&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJUZXJyYWZvcm0iLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.rtmnZenr7kXDLLu-lhX1gwe6o7MhNw_zUuxKLMnszC8&zhida_source=entity) 创作者）在博客中首次明确命名了这一实践，提出核心理念："每当发现 Agent 犯错，就花时间设计一个解决方案，确保 Agent 永远不会再犯同样的错误".
...
**[Can.ac 实验](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Can.ac+%E5%AE%9E%E9%AA%8C&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJDYW4uYWMg5a6e6aqMIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjcxMTQ3MjUwLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.B82OVRU7cXLshkI2ImPo6gClqeHT0wBrdO7Lg7R52nw&zhida_source=entity)** ：仅改变 Harness 的工具格式（编辑接口），就在 16 个模型上显著提升了编码基准分数。效果最显著的 Grok Code Fast 1 从 6.7% 跃升至 68.3%——没有修改任何模型权重.

**[LangChain实验](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=LangChain%E5%AE%9E%E9%AA%8C&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJMYW5nQ2hhaW7lrp7pqowiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.X8OQEmAYFUmWyBTmjPs5J23wSiI265ZUkZo1vYmyLWM&zhida_source=entity)** ：仅通过 Harness 改进，在 Terminal Bench 2.0 上从第 30 名跃升至第 5 名，同一模型提升了 13.7 分。
...
Dex [Horthy](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Horthy&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJIb3J0aHkiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzExNDcyNTAsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.U5qMaUYkb8b1IbltpzPefGHPAbFJmdhbq2MclRS6pAE&zhida_source=entity) 有个很实用的经验观察： **上下文填得越满，LLM输出质量越差** 。以 168K token 的上下文窗口为例，大约用到 40% 就开始走下坡路了：
...
综合 OpenAI、Anthropic、 [Carlini](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Carlini&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJDYXJsaW5pIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjcxMTQ3MjUwLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.UuVHZi-hT3tiUjA42P-zBEvODJSsE6WlYK0LZ0yqd7U&zhida_source=entity) （C 编译器项目）、 [Huntley](https://zhida.zhihu.com/search?content_id=271147250&content_type=Article&match_order=1&q=Huntley&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NzY2OTc4NzksInEiOiJIdW50bGV5IiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjcxMTQ3MjUwLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.UMnj2kOvHcVvVvLEFOqevGU8xpI5YT5QLj3JeF1Ou70&zhida_source=entity) 、Horthy 等五个独立团队的实践，四种模式反复出现并形成收敛。这就是 Harness Engineering 的四大支柱。
...
2. **SmartScope** — What Is Harness Engineering — Harness Engineering 概念定义、与 Prompt/Context Engineering 的关系梳理、Can.ac 量化实验数据。
