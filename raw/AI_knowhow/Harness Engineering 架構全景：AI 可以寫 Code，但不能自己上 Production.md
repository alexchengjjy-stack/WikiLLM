...
source: "https://ai-coding.wiselychen.com/harness-engineering-architecture-overview-ai-code-production-guardrails/"
author:
  - "[[Wisely Chen]]"
...
我之前已經寫過三篇相關的深度文： [Amazon 事件分析](https://ai-coding.wiselychen.com/amazon-ai-code-incident-tech-giants-quietly-locking-ai/) 、 [四層防禦架構](https://ai-coding.wiselychen.com/coders-who-stopped-coding-harness-context-spec-engineering/) 、 [Control Plane 八步拆解](https://ai-coding.wiselychen.com/harness-engineering-control-plane-pattern-agent-review-loop/) 。但這三篇加起來超過一萬字，而且是按時間順序寫的，不是按架構邏輯。
...
![AI 的乾淨狀態偏見：三起事件同一個模式](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-02.png)
...
![兩種防禦哲學的對決：人為禁令 vs. 系統框架](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-03.png)
...
![從對話技巧走向工程體系：Prompt Engineering vs Harness Engineering](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-04.png)
...
![駕馭工程參考架構：三層防禦與七大元件](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-05.png)
...
![元件 1 & 2：系統化上下文與架構護欄](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-09.png)
...
![元件 3 & 4：高吞吐量 CI/PR 與測試評估](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-10.png)
...
![元件 5, 6, 7：安全、觀測與持續回饋](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-11.png)
...
OWASP Top 10 for LLM Applications 把 Prompt Injection 列為關鍵風險之一，提醒不安全輸出處理可能導致下游代碼執行。這不是理論風險——我在 [之前的文章](https://ai-coding.wiselychen.com/ai-coding-tool-security-risk-prompt-injection-rce/) 裡用真實案例分析過。
...
![第一層防禦：基於爆炸半徑的風險契約](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-06.png)
...
![第二層防禦：用確定性工具框住不確定性的 AI](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-07.png)

> 詳細的四層防禦設計和實作經驗，我寫在 [〈Make CI/CD Great Again〉](https://ai-coding.wiselychen.com/coders-who-stopped-coding-harness-context-spec-engineering/) 裡。
...
![第三層防禦：控制平面 Control-Plane Pattern](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-08.png)

> 完整的八步拆解和代碼範例，我寫在 [〈Harness Engineering 完整拆解：Control-Plane Pattern〉](https://ai-coding.wiselychen.com/harness-engineering-control-plane-pattern-agent-review-loop/) 裡。
...
![系統失效模式與對策（一）：上下文與架構](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-12.png)
...
![系統失效模式與對策（二）：測試、安全與供應鏈](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-13.png)
...
![落地實踐：架構護欄與觀測工具矩陣](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-14.png)
...
![導入路線圖：不同規模團隊的落地策略](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-15.png)
...
![系統演進：12 個月建置里程碑](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-16.png)
...
![明天就能開始的三個具體行動](https://ai-coding.wiselychen.com/assets/images/harness-engineering-slide-17.png)
...
1. [亞馬遜 AI 事故啟示：科技巨頭一邊賣 AI 未來，一邊在自己家裡給 AI 上鎖](https://ai-coding.wiselychen.com/amazon-ai-code-incident-tech-giants-quietly-locking-ai/) — 事件分析 + 為什麼禁令不是終點
2. [Make CI/CD Great Again：四層防禦架構](https://ai-coding.wiselychen.com/coders-who-stopped-coding-harness-context-spec-engineering/) — 第二層的完整拆解 + 實作經驗
3. [Harness Engineering 完整拆解：Control-Plane Pattern](https://ai-coding.wiselychen.com/harness-engineering-control-plane-pattern-agent-review-loop/) — 第三層的八步閉環 + 代碼範例
...
- [AI Coding 的第一個風險，不是模型——是你一直按「Yes」](https://ai-coding.wiselychen.com/ai-coding-tool-security-risk-prompt-injection-rce/)
- [混沌智能體：史丹佛 x 哈佛的論文告訴我們，控制好一個 AI Agent 不等於控制好一群](https://ai-coding.wiselychen.com/agents-of-chaos-multi-agent-structural-instability/)
